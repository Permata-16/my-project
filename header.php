...
<html>
  <head>
    ...
    <title>LAUT SUMBER KEHIDUPAN #LAUT KEHIDUPAN</title>
    ...
    <nav class="navbar navbar-default navbar-fixed-top" id="scrollspy">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.php">LAUT SUMBER KEHIDUPAN</a>
        </div>
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav navbar-right">
            ...
            <li>
							<a href="contact.php"><span class="glyphicon glyphicon-info-sign"></span> Contact</a>
						</li>
            <li>
              <a href="laut.php"><span class="glyphicon glyphicon-hand-down"></span> Laut</a>
            </li>
						<li>
							<a href="galeri.php"><span class="glyphicon glyphicon-picture"></span> Galeri</a>
						</li>
            <li>
              <a href="komentar.php"><span class="glyphicon glyphicon-info-sign"></span> komentar</a>
            </li>
            <li>
