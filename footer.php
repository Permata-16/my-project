<!-- FOOTER -->
		...
		<div class="row">
			<div class="col-md-12">
				<center>Copyright &copy 2024 Website LAUT SUMBER KEHIDUPAN, design with <span class="glyphicon glyphicon-heart"></span> by INTAN PERMATA MULIA<br/>
				<a href="index.php">Home </a> | 
				<a href="about.php">About Us </a> | 
				<a href="contact.php">Contact </a> |
				<a href="contact.php">info laut </a> |
				<a href="contact.php">Galeri </a> |
